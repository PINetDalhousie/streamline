...
for value in "${array[@]}";do
    echo "Start simulation for scenario: $1 Mbps, $value msg/s"
    ...
    sudo mkdir -p use-cases/varying-networking-conditions/varying-link-bw/military-coordination/logs/$1"Mbps"/scenario-$value"msgPs" 
    sudo chmod -R 777 use-cases/varying-networking-conditions/varying-link-bw/military-coordination/logs/$1"Mbps"/scenario-$value"msgPs"
