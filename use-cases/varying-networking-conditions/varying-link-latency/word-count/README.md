...
<!-- to run with spark standalone cluster (master & multiple worker instance on same machine):
sudo python3 main.py use-cases/varying-networking-conditions/varying-link-latency/word-count/input.graphml --spark-cluster 1 -->