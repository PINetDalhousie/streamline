...
messageFilePath = "use-cases/benchmarking/Cars103.xml"
...
class ExamplePublisher(object):
    ...
    def on_connection_open_error(self, _unused_connection, err):
        ...
        """
        logging.error('Connection open failed, reopening in 5 seconds: %s', err)
    ...
    def on_delivery_confirmation(self, method_frame):
        ...
        logging.info('Received %s for delivery tag: %i (multiple: %s)', confirmation_type, delivery_tag, ack_multiple)
        logging.info('Produced message ID: %s; Value: %s', str(delivery_tag).zfill(6), method_frame.method)  
    ...
    def publish_message(self):
        ...
        newMsgID = str(self._message_number).zfill(6)
        ...
        routing_key = "topic." + topicName
        
        properties = pika.BasicProperties(app_id=newNodeID,
                                          message_id=newMsgID,
