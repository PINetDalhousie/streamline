...
To train the model:
 ```sudo python3 main.py use-cases/app-testing/fraud-detection/spark-fraud-detection/input_only_spark.graphml --only-spark 1```

 To predict on testing data:
  ```sudo python3 main.py use-cases/app-testing/fraud-detection/spark-fraud-detection/input.graphml```
   
<!-- command to run the temporary script: sudo python3 main.py use-cases/app-testing/fraud-detection/spark-fraud-detection/input-temp.graphml-->
